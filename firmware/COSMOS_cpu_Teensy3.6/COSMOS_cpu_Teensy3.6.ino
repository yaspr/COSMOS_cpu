//Teensy 3.6 version - 1MB flash + 256KB SRAM
...
#define EXEC_CMD  0x5F455845  //_EXE
...
//Strings entryV: nb_strings (4B) len0 (1B) string len1 (1B) string ...
	  ...
	  if (csec)
	    {
	      ...
	      if (ret != EXEC_HALT)
		Serial.print("EXECUTION ERROR: #"), Serial.println(ret);   
	    }
